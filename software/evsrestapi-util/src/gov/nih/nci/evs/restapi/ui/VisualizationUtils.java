...
*/
    ...
    public static void main(String [] args) {
		...
		System.out.println("\n");
		String graph = visualizationUtils.generateGraphScript(codingSchemeURN, codingSchemeVersion, namespace, code, NODES_AND_EDGES);
		System.out.println(graph);

		String outputfile = "graph.txt";
		PrintWriter pw = null;
		try {
			pw = new PrintWriter("graph.txt", "UTF-8");
			pw.println(graph);
		} catch (Exception ex) {
			ex.printStackTrace();
		} finally {
