...
/**
 * Unit FhirR4Tests. Tests the functionality of the FHIR R4 endpoint CodeSystem specifically the
 * general operations.
 */
@ExtendWith(SpringExtension.class)
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@AutoConfigureMockMvc
class FhirR4CodeSystemGeneralOperations {
  ...
  public void testCodeSystemValidate() throws Exception {
    ...
    content =
        this.restTemplate.getForObject(endpoint + "/" + codeSystemId + "/$validate", String.class);
  ...
  public void testCodeSystemMeta() throws Exception {
    ...
    // Act
    content =
        this.restTemplate.getForObject(endpoint + "/" + codeSystemId + "/$meta", String.class);
    outcome = parser.parseResource(OperationOutcome.class, content);
    component = outcome.getIssueFirstRep();
  ...
  public void testCodeSystemGraphql() throws Exception {
    ...
    // Act
    content =
        this.restTemplate.getForObject(endpoint + "/" + codeSystemId + "/$graphql", String.class);
    outcome = parser.parseResource(OperationOutcome.class, content);
    component = outcome.getIssueFirstRep();
