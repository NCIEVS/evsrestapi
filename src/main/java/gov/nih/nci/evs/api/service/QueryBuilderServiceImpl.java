...
public class QueryBuilderServiceImpl implements QueryBuilderService {
  ...
  public String constructAllGraphNamesQuery() {
    StringBuffer query = new StringBuffer();
    query.append(
        "select distinct ?graphName where { graph ?graphName {?s ?p ?o} }");
  ...
  public String constructPropertyQuery(String conceptCode, String namedGraph) {
    StringBuffer query = new StringBuffer();
    query.append(
        "SELECT ?property ?propertyCode  ?propertyLabel ?propertyValue\n");
    query.append("{ GRAPH <" + namedGraph + ">");
  ...
  public String constructPropertyNoRestrictionsQuery(String conceptCode,
    ...
    query.append("  { ?concept :NHC0 " + "\"" + conceptCode + "\" .\n");
    query.append("    ?concept ?property ?propertyValue .\n");
    query.append("    OPTIONAL { ?property rdfs:label ?propertyLabel }.\n");
    query.append("    OPTIONAL { ?property :NHC0 ?propertyCode }\n");
    query.append("  }\n");
    query.append("}\n");

    log.debug("constructPropertyNoRestrictionsQuery - " + query.toString());
    return query.toString();
  }
  ...
  public String constructAssociationsQuery(String conceptCode,
    ...
    StringBuffer query = new StringBuffer();
    query.append(
        "SELECT ?relationshipCode ?relationship ?relatedConceptCode ?relatedConceptLabel\n");
    query.append("{\n");
    query.append("    GRAPH <" + namedGraph + ">\n");
    query.append("    {\n");
  ...
  public String constructInverseAssociationsQuery(String conceptCode,
    ...
    StringBuffer query = new StringBuffer();
    query.append(
        "SELECT ?relationshipCode ?relatedConceptLabel ?relatedConceptCode ?relationship\n");
    query.append("{\n");
    query.append("    GRAPH <" + namedGraph + ">\n");
    query.append("    {\n");
    query.append("        ?z a owl:Class .\n");
    query.append("        ?z rdfs:label ?z_label .\n");
    query.append("        ?z :NHC0 \"" + conceptCode
        + "\"^^<http://www.w3.org/2001/XMLSchema#string> .\n");
    query.append("        ?x a owl:Class .\n");
  ...
  public String constructInverseRolesQuery(String conceptCode,
    ...
    StringBuffer query = new StringBuffer();
    query.append(
        "SELECT distinct ?relatedConceptLabel ?relatedConceptCode ?relationship ?relationshipCode\n");
    query.append("{\n");
    query.append("    GRAPH <" + namedGraph + ">\n");
    query.append("    {\n");
    query.append("      {\n");
    ...
    query.append("        ?y :NHC0 \"" + conceptCode
        + "\"^^<http://www.w3.org/2001/XMLSchema#string> .\n");
  ...
  public String constructRolesQuery(String conceptCode, String namedGraph) {
    StringBuffer query = new StringBuffer();
    query.append(
        "SELECT distinct ?relationship ?relationshipCode ?relatedConceptLabel ?relatedConceptCode \n");
    query.append("{\n");
    query.append("    graph <" + namedGraph + ">\n");
    query.append("    {\n");
    query.append("      {\n");
  ...
  public String constructDisjointWithQuery(String conceptCode,
    ...
    StringBuffer query = new StringBuffer();
    query.append(
        "SELECT ?relatedConceptLabel ?relatedConceptCode ?relationship\n");
    query.append("{\n");
    query.append("    GRAPH <" + namedGraph + ">\n");
    query.append("    {\n");
    query.append("        ?x a owl:Class .\n");
  ...
  public String constructAllRolesQuery(String namedGraph) {
    ...
    query.append(
        "SELECT ?property ?propertyCode  ?propertyLabel ?propertyValue\n");
    query.append("{ GRAPH <" + namedGraph + ">");
    query.append("  { ?property a owl:ObjectProperty .\n");
    query.append("    ?property rdfs:label ?propertyLabel .\n");
    query.append("    ?property :NHC0 ?propertyCode .\n");
    query.append("    ?property :P108 ?propertyValue \n");
    query.append("  }\n");
