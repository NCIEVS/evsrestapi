...
public class EVSUtils {
	...
	public static String[] COMMON_PROPERTIES = {"code", "label", "Preferred_Name", "DEFINITION", "ALT_DEFINITION",
            "FULL_SYN", "Maps_To", "GO_Annotation"};
	public static List <EvsProperty> getAdditionalPropertiesByCode(List <EvsProperty>properties) {
	...
	public static List <EvsSynonym> getSynonyms(List <EvsAxiom>axioms, String outputType) {
	...
	public static List <EvsDefinition> getDefinitions(List <EvsAxiom>axioms, String outputType) {
	...
	public static List <EvsDefinition> getAltDefinitions(List <EvsAxiom>axioms, String outputType) {
		ArrayList <EvsDefinition> results = new ArrayList<EvsDefinition>();
		for ( EvsAxiom axiom: axioms) {
	...
	public static List <EvsMapsTo> getMapsTo(List <EvsAxiom>axioms, String outputType) {
	...
	public static List <EvsGoAnnotation> getGoAnnotations(List <EvsAxiom>axioms, String outputType) {
