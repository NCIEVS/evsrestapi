...
public class FhirMetadataProviderR4 extends ServerCapabilityStatementProvider {
  ...
  public IBaseConformance getMetadataResource(
    ...
    // Check if the request is for general CapabilityStatement
      ...
      capabilityStatement.setUrl("https://api-evsrest.nci.nih.gov/fhir/r4/metadata");
      capabilityStatement.setVersion(VersionController.VERSION);
      capabilityStatement.setName("EVSRESTAPIFHIRTerminologyServer");
      capabilityStatement.setTitle("EVSRESTAPI R4 FHIR Terminology Server");
