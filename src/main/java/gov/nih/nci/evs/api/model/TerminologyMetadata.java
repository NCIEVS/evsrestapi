...
public class TerminologyMetadata extends BaseModel {
    ...
    public int hashCode() {
        ...
        result = prime * result
                + ((mapTargetTerminology == null) ? 0 : mapTargetTerminology.hashCode());
        result = prime * result + ((mapTargetTerminologyVersion == null) ? 0
                : mapTargetTerminologyVersion.hashCode());
        ...
        result = prime * result
                + ((definitionSourceSet == null) ? 0 : definitionSourceSet.hashCode());
        ...
        result = prime * result
                + ((preferredTermTypes == null) ? 0 : preferredTermTypes.hashCode());
    ...
    public boolean isRemodeledProperty(final String code) {
        ...
        // || getMap().equals(code)
        return getSynonym().contains(code) || getDefinition().contains(code)
    ...
    public boolean isRemodeledQualifier(final String code) {
        return code.equals(synonymTermType) || code.equals(synonymSource)
                || code.equals(synonymCode) || code.equals(synonymSubSource)
                || code.equals(definitionSource) || code.equals(mapRelation)
                || code.equals(mapTarget) || code.equals(mapTargetTermType)
