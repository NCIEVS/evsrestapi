...
public class SubsetController extends BaseController {
  ...
  @RecordMetric
  @GetMapping(value = "/subset/{terminology}", produces = "application/json")
  ...
  @RecordMetric
  @GetMapping(value = "/subset/{terminology}/{code}", produces = "application/json")
  ...
  @Operation(
      summary =
          "Get subset members for the specified terminology and code. Concept subset endpoints will"
              + " be deprecated in v2 in favor of top level subset endpoints.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        description = "Successfully retrieved the requested information"),
