 ...
 * from where the cache is called from, otherwise the @Cacheable annotation is ignored and the method
 * is treated as private while using proxy-based AOP.
 */
@Service
public class SparqlQueryCacheService {
    ...
    public List<String> getHierarchy(final Terminology terminology, RESTUtils restUtils, SparqlQueryManagerService sparqlQueryManagerService) throws Exception {
    ...
    public List<Concept> getAllQualifiers(final Terminology terminology, final IncludeParam ip, RESTUtils restUtils, SparqlQueryManagerService sparqlQueryManagerService)
            throws Exception {
        final String queryPrefix = queryBuilderService.constructPrefix(terminology);
    ...
    @Cacheable(value = "terminology",
            key = "{#root.methodName, #terminology.getTerminologyVersion()}")
    public HierarchyUtils getHierarchyUtils(final Terminology terminology, RESTUtils restUtils, SparqlQueryManagerService sparqlQueryManagerService) throws Exception {
        final List<String> parentchild = this.getHierarchy(terminology, restUtils, sparqlQueryManagerService);
