...
public class ValueSetProviderR5 implements IResourceProvider {
        ...
        try {
            ...
            if (vsList.isEmpty()) {
                throw FhirUtilityR5.exception(
                        "Value set " + url + " not found", IssueType.EXCEPTION, 500);
            }
            ...
            final ValueSet.ValueSetExpansionComponent vsExpansion = new ValueSet.ValueSetExpansionComponent();
            ...
            throw FhirUtilityR5.exception(
                    "Failed to load value set", IssueType.EXCEPTION, 500);
        }
    }
    ...
    public Bundle findValueSets(
            ...
            @Description(shortDefinition = "Number of entries to return") @OptionalParam(name = "_count") NumberParam count,
        ...
        for (final Concept subset : subsetsAsConcepts) {
            ...
            if (code != null
                && !vs.getIdentifier().stream()
                      .anyMatch(i -> i.getValue().equals(code.getValue()))) {
