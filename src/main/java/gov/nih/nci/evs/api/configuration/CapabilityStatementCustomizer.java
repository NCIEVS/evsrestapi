...
public class CapabilityStatementCustomizer {
  ...
  public void customize(IBaseConformance theCapabilityStatement) {
    if (theCapabilityStatement instanceof CapabilityStatement capabilityStatement) {
      capabilityStatement.addInstantiates(
      ...
      // if (codeSystem != null) {
      TerminologyCapabilities.TerminologyCapabilitiesCodeSystemComponent codeSystemComponent =
      ...
      codeSystemComponent
          .addVersion()
          .setCode("http://snomed.info/sct/9000000000000207008/version/20250101")
          .setIsDefault(true);
