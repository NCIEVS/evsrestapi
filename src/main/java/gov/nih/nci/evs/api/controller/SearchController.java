...
public class SearchController extends BaseController {
  ...
  public @ResponseBody ConceptResultList searchSingleTerminology(
    ...
    BindingResult bindingResult, @RequestHeader(name = "X-EVSRESTAPI-License-Key", required = false)
  ...
  public @ResponseBody ConceptResultList searchSingleTerminologySparql(
    ...
    final String query, @ModelAttribute SearchCriteriaWithoutTerminology searchCriteria,
    @RequestParam(required = false, name = "include")
    final Optional<String> include, BindingResult bindingResult,
    @RequestHeader(name = "X-EVSRESTAPI-License-Key", required = false)
