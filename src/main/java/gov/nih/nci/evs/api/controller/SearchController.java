...
public class SearchController {
	...
	@ApiOperation(value = "${swagger.documentation.searchAPIOperation}",
		    ...
		    + "  <td><a href='api/v1/search?term=3-Phosphoinositide&property=gene_encodes_product&returnProperties=gene_encodes_product&pageSize=100' target='_blank'>api/v1/search?term=3-Phosphoinositide&property=gene_encodes_product&returnProperties=gene_encodes_product&pageSize=100</a></td> "
		    + " </tr>"
		    + " <tr>"
		    ...
		    + " api/v1/search?term=dsDNA&synonymSource=NICHD</a></td> "
		    + " </tr>"
		    + " </table>"		  
		    + "\n\n"
		    ...
		    + "<a href='api/v1/search?term=Biological&fromRecord=0&pageSize=100&associationSearch=source'>api/v1/search?term=Biological&fromRecord=0&pageSize=100&associationSearch=source</a><br>"
		    ...
		    + "<a href='api/v1/search?term=dna&pageSize=100&associationSearch=source&relationship=Has_Target'>api/v1/search?term=dna&fromRecord=0&pageSize=100&associationSearch=source&relationship=Has_Target</a><br>"
		    + "<a href='api/v1/search?term=dna&pageSize=100&associationSearch=source&relationship=A7'>api/v1/search?term=dna&fromRecord=0&pageSize=100&associationSearch=source&relationship=A7</a><br>"
		    ...
		    +	"}<br>"
		    + "<br>"
		    + "<a href='api/v1/search?term=Biological&fromRecord=0&pageSize=100&associationSearch=source&relationship=A2,A11'>"
		    ...
		    + "Example: <br>"
		    + "**with the associationSearch and relationship specified**<br>"
		    + "<a href='api/v1/search?term=Biological&pageSize=100&associationSearch=target&relationship=A2,A11'>api/v1/search?term=Biological&pageSize=100&associationSearch=target&relationship=A2,A11</a><br>"
			...
			+ "<a href='api/v1/search?term=Isomerase&fromRecord=0&pageSize=100&roleSearch=source'>api/v1/search?term=Isomerase&fromRecord=0&pageSize=100&roleSearch=source</a><br>"
			...
			+ "<a href='api/v1/search?term=Isomerase&fromRecord=0&pageSize=100&roleSearch=source&relationship=Gene_Product_Encoded_By_Gene'>api/v1/search?term=Isomerase&fromRecord=0&pageSize=100&roleSearch=source&relationship=Gene_Product_Encoded_By_Gene</a><br>"
			+ "<a href='api/v1/search?term=Isomerase&fromRecord=0&pageSize=100&roleSearch=source&relationship=r54'>api/v1/search?term=Isomerase&fromRecord=0&pageSize=100&roleSearch=source&relationship=r54</a><br>"
			...
			+ "}"
			+ "<br>"
			+ "<a href='api/v1/search?term=Biological&fromRecord=0&pageSize=100&roleSearch=source&relationship=R54,R44'>"
			+ "api/v1/search?term=Biological&fromRecord=0&pageSize=100&roleSearch=source&relationship=R54,R44</a>\n"
			...
			+ "Example:<br>"
			+ "<a href='api/v1/search?term=Triosephosphate&fromRecord=0&pageSize=100&roleSearch=target&relationship=r54'>api/v1/search?term=Triosephosphate&fromRecord=0&pageSize=100&roleSearch=target&relationship=r54</a><br>"
