...
public class SearchController {
	...
	@ApiOperation(value = "${swagger.documentation.searchAPIOperation}",
		    ...
		    + "  <td><a href='api/v1/concept/elasticsearch?term=melanoma' target='_blank'>api/v1/concept/elasticsearch?term=melanoma</a></td> "		    
		    + "  </tr>"
		    + " <tr>"
		    + "   <td>will return 10th record to 20th record. The next 10 reocrds for the term melanoma (say page 2)</td>"
		    + "  <td> <a href='/api/v1/concept/elasticsearch?term=melanoma&fromRecord=10&pagesize=10' target='_blank'>/api/v1/concept/elasticsearch?term=melanoma&fromRecord=10&pagesize=10<a></td> "
		    + " </tr>"
		    + " <tr>"
		    + "   <td>will return 20th record to 30th record. The next 10 records for the term melanoma from the 20th record. (say page 3)</td>"
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=melanoma&fromRecord=20&pagesize=10' target='_blank'>/api/v1/concept/elasticsearch?term=melanoma&fromRecord=20&pagesize=10</a></td> "
		    + " </tr>"
		    + " <tr>"
		    + "   <td>will return 1st record to the 100th record</td>"
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=melanoma&fromRecord=0&pagesize=100' target='_blank'>/api/v1/concept/elasticsearch?term=melanoma&fromRecord=0&pagesize=100</a></td> "
		    + " </tr>"
		    + " </table>"
		    + "\n\n"
		    + "# Format\n"
		    ...
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=carcinoma&format=clean' target='_blank'>/api/v1/concept/elasticsearch?term=carcinoma&format=clean</a></td> "		    
		    + "  </tr>"
		    + " <tr>"
		    ...
		    + "  <td> <a href='/api/v1/concept/elasticsearch?term=metastasize&format=cleanWithHighlights' target='_blank'>/api/v1/concept/elasticsearch?term=metastasize&format=cleanWithHighlights<a></td> "
		    + " </tr>"
		    + " <tr>"
		    + "   <td>raw format is the data returned by the elastic search server.</td>"
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=metastasize&format=raw' target='_blank'>/api/v1/concept/elasticsearch?term=metastasize&format=raw</a></td> "
		    + " </tr>"
		    + " <tr>"
		    + "   <td>Returns the first 100 rows in clean format</td>"
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=melanoma&pagesize=100&format=clean' target='_blank'>/api/v1/concept/elasticsearch?term=melanoma&pagesize=100&format=clean</a></td> "
		    + " </tr>"
		    + " </table>"
		    + "\n\n"
		    + "# Type\n"
		    ...
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=carcinom&format=cleanWithHighlights' target='_blank'>/api/v1/concept/elasticsearch?term=carcinom&format=cleanWithHighlights</a></td> "		    
		    + "  </tr>"
		    + " <tr>"
		    + "   <td>phrase search - will find the concepts where the phrase exists in any of the properties</td>"
		    + "  <td> <a href='/api/v1/concept/elasticsearch?term=Lung%20Carcinoma&type=phrase&format=cleanWithHighlights' target='_blank'>/api/v1/concept/elasticsearch?term=Lung%20Carcinoma&type=phrase&format=cleanWithHighlights<a></td> "
		    + " </tr>"
		    + " <tr>"
		    ...
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=lentiginous%20melanoma&type=AND' target='_blank'>/api/v1/concept/elasticsearch?term=lentiginous%20melanoma&type=AND</a></td> "
		    + " </tr>"
		    + " <tr>"
		    + "   <td>OR search - will find the concepts that have the any or all words specified in any property of the concept</td>"
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=lentiginous%20melanoma&type=OR' target='_blank'>/api/v1/concept/elasticsearch?term=lentiginous%20melanoma&type=OR</a></td> "
		    + " </tr>"
		    + " <tr>"
		    + "   <td>exact Match search - will find the concepts that have the term or phrase specified matching a property value exactly</td>"
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=Lung%20Carcinoma&type=match' target='_blank'>/api/v1/concept/elasticsearch?term=Lung%20Carcinoma&type=match</a></td> "
		    + " </tr>"
		    + " <tr>"
		    + "   <td>fuzzy search - The fuzzy query uses similarity based on Levenshtein edit distance.</td>"
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=enzymi&type=fuzzy' target='_blank'>/api/v1/concept/elasticsearch?term=enzymi&type=fuzzy</a></td> "
		    + " </tr>"
		    + " <tr>"
		    + "   <td>starts with search - will find the concepts that have a property value starting with the term or phrase specified </td>"
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=enzyme&type=startswith' target='_blank'>/api/v1/concept/elasticsearch?term=enzyme&type=startswith</a></td> "
		    + " </tr>"
		    + " </table>"
		    + "\n\n"   
		    + "# Property\n"
		    ...
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=lung%20carcinoma&type=match&format=cleanWithHighlights&property=full_syn,preferred_name' target='_blank'>/api/v1/concept/elasticsearch?term=lung%20carcinoma&type=match&format=cleanWithHighlights&property=full_syn,preferred_name</a></td>"
		    + "  </tr>"
		    + " <tr>"
		    + "   <td>Will search in the FDA_UNII_CODE property for the term XAV05295I5</td>"
		    + "  <td> <a href='/api/v1/concept/elasticsearch?term=XAV05295I5&format=cleanWithHighlights&property=fda_unii_code' target='_blank'>/api/v1/concept/elasticsearch?term=XAV05295I5&format=cleanWithHighlights&property=fda_unii_code<a></td> "
		    + " </tr>"
		    + " <tr>"
		    + "   <td>Will search in the Maps_To property for the term Hydronephrosis and wil return only the maps_to property</td>"
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=Hydronephrosis&returnProperties=maps_to&property=maps_to' target='_blank'>/api/v1/concept/elasticsearch?term=Hydronephrosis&returnProperties=maps_to&property=maps_to</a></td> "
		    + " </tr>"
		    + " <tr>"
		    + "   <td>Will search in the gene_encodes_product property</td>"
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=3-Phosphoinositide&property=gene_encodes_product&returnProperties=gene_encodes_product&pageSize=100' target='_blank'>/api/v1/concept/elasticsearch?term=3-Phosphoinositide&property=gene_encodes_product&returnProperties=gene_encodes_product&pageSize=100</a></td> "
		    + " </tr>"
		    + " <tr>"
		    + "   <td>Will search in the neoplastic_status property</td>"
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=Benign&type=match&property=neoplastic_status&returnProperties=neoplastic_status&format=cleanWithHighlights' target='_blank'>/api/v1/concept/elasticsearch?term=Benign&type=match&property=neoplastic_status&returnProperties=neoplastic_status&format=cleanWithHighlights</a></td> "
		    + " </tr>"
		    + " </table>"
		    + "\n\n"  
		    + "# Return Properties\n"
		    ...
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=carcinoma&format=clean&returnProperties=all' target='_blank'>/api/v1/concept/elasticsearch?term=carcinoma&format=clean&returnProperties=all</a></td>"
		    + "  </tr>"
		    + " <tr>"
		    + "   <td>short - Will return a short list of properties(Code,Label,Display_Name,Preferred_Name) of the match concepts</td>"
		    + "  <td> <a href='/api/v1/concept/elasticsearch?term=carcinoma&format=clean&returnProperties=short' target='_blank'>/api/v1/concept/elasticsearch?term=carcinoma&format=clean&returnProperties=short<a></td> "
		    + " </tr>"
		    + " <tr>"
		    + "   <td>specific properties - will return roles and associations of the concepts. Code and Label are returned by default</td>"
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=carcinoma&format=clean&returnProperties=roles,associations' "
		    + "  target='_blank'>/api/v1/concept/elasticsearch?term=carcinoma&format=clean&returnProperties=roles,associations</a></td> "
		    + " </tr>"
		    + " <tr>"
		    + "   <td>specific properties - will return roles and definition of the concepts</td>"
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=carcinoma&format=clean&returnProperties=roles,definition' target='_blank'>/api/v1/concept/elasticsearch?term=carcinoma&format=clean&returnProperties=roles,definition</a>"
		    ...
		    + "  <td>"
		    + "<a href='/api/v1/concept/elasticsearch?term=XAV05295I5&returnProperties=fda_unii_code' target='_blank'>"
		    + " /api/v1/concept/elasticsearch?term=XAV05295I5&returnProperties=fda_unii_code</a> <br>"
		    + "<a href='/api/v1/concept/elasticsearch?term=XAV05295I5&returnProperties=fda_unii_code' target='_blank'>"
		    + " /api/v1/concept/elasticsearch?term=XAV05295I5&returnProperties=P319</a>"
		    + "</td> "
		    + " </tr>"
		    + " </table>"		  
		    + "\n"
		    ...
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=dsDNA&synonymSource=NCI' target='_blank'>/api/v1/concept/elasticsearch?term=dsDNA&synonymSource=NCI</a></td>"
		    + "  </tr>"
		    + " <tr>"
		    + "   <td>Will search for the term dsDNA in the synonyms of all the concepts where the source is NCI and the group is SY. </td>"
		    + "  <td> <a href='/api/v1/concept/elasticsearch?term=dsDNA&synonymSource=NCI&synonymGroup=SY' target='_blank'>/api/v1/concept/elasticsearch?term=dsDNA&synonymSource=NCI&synonymGroup=SY<a></td> "
		    + " </tr>"
		    + " <tr>"
		    ...
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=dsDNA&synonymSource=NCI&synonymGroup=PT' "
		    + "  target='_blank'>/api/v1/concept/elasticsearch?term=dsDNA&synonymSource=NCI&synonymGroup=PT</a></td> "
		    + " </tr>"
		    + " <tr>"
		    + "   <td>search for term Humoral thats exists in the synonyms for same source but two different groups</td>"
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=Humoral&synonymSource=NCI&synonymGroup=SY' target='_blank'>"
		    + "      /api/v1/concept/elasticsearch?term=Humoral&synonymSource=NCI&synonymGroup=SY</a><br><br>"
		    + " <a href='/api/v1/concept/elasticsearch?term=Humoral&synonymSource=NCI&synonymGroup=PT' target='_blank'>" 
	        + "  /api/v1/concept/elasticsearch?term=Humoral&synonymSource=NCI&synonymGroup=PT</a></td> "
		    + " </tr>"
		    + " <tr>"
		    + "   <td>Will search in the source NICHD</td>"
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=dsDNA&synonymSource=NICHD' target='_blank'>"
		    + " /api/v1/concept/elasticsearch?term=dsDNA&synonymSource=NICHD</a></td> "
		    + " </tr>"
		    + " </table>"		  
		    + "\n\n"
		    ...
		    + "  <td><a href='/api/v1/concept/elasticsearch?term=Dilation&definitionSource=NCI' target='_blank'>/api/v1/concept/elasticsearch?term=Dilation&definitionSource=NCI</a></td>"
		    + "  </tr>"
		    + " <tr>"
		    ...
		    + "  <td> <a href='/api/v1/concept/elasticsearch?term=cervical%20spine%20joint&type=phrase&definitionSource=CTCAE' target='_blank'>/api/v1/concept/elasticsearch?term=cervical%20spine%20joint&type=phrase&definitionSource=CTCAE<a></td> "
		    + " </tr>"		    
		    + " </table>"	
		    + "\n\n"
		    ...
		    + "Check the end of the output of a search result when the format=raw : <a href='/api/v1/concept/elasticsearch?term=melanoma' target='_blank'>/api/v1/concept/elasticsearch?term=melanoma</a>\n"
		    ...
		    + "  <td><a href='api/v1/concept/elasticsearch?term=melanoma&contributingSource=CTEP' target='_blank'>api/v1/concept/elasticsearch?term=melanoma&contributingSource=CTEP</a></td>"
		    + "  </tr>"
		    + " <tr>"
		    ...
		    + "  <td><a href='api/v1/concept/elasticsearch?term=melanoma&conceptStatus=Retired_Concept' target='_blank'>api/v1/concept/elasticsearch?term=melanoma&conceptStatus=Retired_Concept</a></td> "
		    + " </tr>"
		    + " </table>"
			+ "\n\n"
		    ...
		    + "<a href='/api/v1/concept/elasticsearch?term=Biological&fromRecord=0&pageSize=100&associationSearch=source'>/api/v1/concept/elasticsearch?term=Biological&fromRecord=0&pageSize=100&associationSearch=source</a><br>"
		    ...
		    + "<a href='/api/v1/concept/elasticsearch?term=dna&pageSize=100&associationSearch=source&relationship=Has_Target'>api/v1/concept/elasticsearch?term=dna&fromRecord=0&pageSize=100&associationSearch=source&relationship=Has_Target</a><br>"
		    + "<a href='/api/v1/concept/elasticsearch?term=dna&pageSize=100&associationSearch=source&relationship=A7'>api/v1/concept/elasticsearch?term=dna&fromRecord=0&pageSize=100&associationSearch=source&relationship=A7</a><br>"
		    ...
		    +	"}<br>"
		    + "<br>"
		    + "<a href='/api/v1/concept/elasticsearch?term=Biological&fromRecord=0&pageSize=100&associationSearch=source&relationship=A2,A11'>"
		    + "api/v1/concept/elasticsearch?term=Biological&fromRecord=0&pageSize=100&associationSearch=source&relationship=A2,A11</a><br>"
		    ...
		    + "Example: <br>"
		    + "**with the associationSearch and relationship specified**<br>"
		    + "<a href='/api/v1/concept/elasticsearch?term=Biological&pageSize=100&associationSearch=target&relationship=A2,A11'>api/v1/concept/elasticsearch?term=Biological&pageSize=100&associationSearch=target&relationship=A2,A11</a><br>"
			...
			+ "<a href='/api/v1/concept/elasticsearch?term=Isomerase&fromRecord=0&pageSize=100&roleSearch=source'>api/v1/concept/elasticsearch?term=Isomerase&fromRecord=0&pageSize=100&roleSearch=source</a><br>"
			...
			+ "<a href='/api/v1/concept/elasticsearch?term=Isomerase&fromRecord=0&pageSize=100&roleSearch=source&relationship=Gene_Product_Encoded_By_Gene'>api/v1/concept/elasticsearch?term=Isomerase&fromRecord=0&pageSize=100&roleSearch=source&relationship=Gene_Product_Encoded_By_Gene</a><br>"
			+ "<a href='/api/v1/concept/elasticsearch?term=Isomerase&fromRecord=0&pageSize=100&roleSearch=source&relationship=r54'>api/v1/concept/elasticsearch?term=Isomerase&fromRecord=0&pageSize=100&roleSearch=source&relationship=r54</a><br>"
			...
			+ "}"
			+ "<br>"
			+ "<a href='/api/v1/concept/elasticsearch?term=Biological&fromRecord=0&pageSize=100&roleSearch=source&relationship=R54,R44'>"
			+ "api/v1/concept/elasticsearch?term=Biological&fromRecord=0&pageSize=100&roleSearch=source&relationship=R54,R44</a>\n"
			...
			+ "Example:<br>"
			+ "<a href='/api/v1/concept/elasticsearch?term=Triosephosphate&fromRecord=0&pageSize=100&roleSearch=target&relationship=r54'>api/v1/concept/elasticsearch?term=Triosephosphate&fromRecord=0&pageSize=100&roleSearch=target&relationship=r54</a><br>"
