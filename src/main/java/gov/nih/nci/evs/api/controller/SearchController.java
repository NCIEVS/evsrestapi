...
public class SearchController extends BaseController {
  ...
  @ApiImplicitParams({
      ...
      @ApiImplicitParam(name = "sortBy", value = "The search parameter to sort results by",
          required = false, dataTypeClass = String.class, paramType = "query", defaultValue = ""),
      @ApiImplicitParam(name = "descending",
          value = "Sort by descending (if true) or ascending (if false)", required = false,
