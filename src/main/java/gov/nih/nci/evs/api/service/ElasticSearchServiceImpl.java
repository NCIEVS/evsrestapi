...
public class ElasticSearchServiceImpl implements ElasticSearchService {
    ...
    private BoolQueryBuilder getContainsQuery(final String type, final String term, boolean fuzzyFlag,
        ...
        final QueryStringQueryBuilder synonymNamesQuery = QueryBuilders.queryStringQuery(fixNormTerm)
                .field("synonyms.name", 10f);
        ...
        final QueryStringQueryBuilder nameQuery1 = QueryBuilders.queryStringQuery(fixterm).field("name", 20f);
        final QueryStringQueryBuilder nameQuery2 = QueryBuilders.queryStringQuery(fixNormTerm).field("name", 20f);
        ...
        final QueryStringQueryBuilder codeQuery = QueryBuilders.queryStringQuery(codeTerm).field("code", 20f);
