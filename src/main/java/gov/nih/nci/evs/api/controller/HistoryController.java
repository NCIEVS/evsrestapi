...
public class HistoryController extends BaseController {
  ...
  @Operation(
      summary =
          "Gets suggested replacements for a specified terminology and retired code."
  ...
  @Operation(
      summary =
          "Gets suggested replacements for a specified terminology and"
  ...
  @Parameters({
    ...
    @Parameter(
        name = "list",
        description =
            "Comma-separated list of codes, e.g. "
                + "<ul><li>'C4654,C40117' for <i>ncit</i></li>"
