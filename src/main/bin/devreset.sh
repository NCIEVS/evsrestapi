...
echo "    load data"
/opt/stardog/bin/stardog data add --named-graph http://NCI_T_weekly CTRP /Users/squareroot/temp/UnitTestData/ThesaurusInferred_+1weekly.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://NCI_T_monthly CTRP /Users/squareroot/temp/UnitTestData/ThesaurusInferred_monthly.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://NCI_T_monthly NCIT2 /Users/squareroot/temp/UnitTestData/ThesaurusInferred_monthly.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://GO_monthly NCIT2 /Users/squareroot/temp/UnitTestData/GO/go.2022-07-01.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://HGNC_monthly NCIT2 /Users/squareroot/temp/UnitTestData/HGNC/HGNC_202209.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://ChEBI_monthly NCIT2 /Users/squareroot/temp/UnitTestData/ChEBI/chebi_213.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://UmlsSemNet NCIT2 /Users/squareroot/temp/UnitTestData/UmlsSemNet/umlssemnet.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://MEDRT NCIT2 /Users/squareroot/temp/UnitTestData/MED-RT/medrt.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://Canmed NCIT2 /Users/squareroot/temp/UnitTestData/Canmed/canmed.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://CTCAE NCIT2 /Users/squareroot/temp/UnitTestData/CTCAE/ctcae5.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://DUO_monthly NCIT2 /Users/squareroot/temp/UnitTestData/DUO/duo_Feb21.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://DUO_monthly NCIT2 /Users/squareroot/temp/UnitTestData/DUO/iao_Dec20.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://OBI_monthly NCIT2 /Users/squareroot/temp/UnitTestData/OBI/obi_2022_07.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://OBIB NCIT2 /Users/squareroot/temp/UnitTestData/OBIB/obib_2021-11.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://NDFRT2 NCIT2 /Users/squareroot/temp/UnitTestData/NDFRT/NDFRT_Public_2018.02.05_Inferred.owl | sed 's/^/      /'

/opt/stardog/bin/stardog data add --named-graph http://MGED NCIT2 /Users/squareroot/temp/UnitTestData/MGED/MGEDOntology.fix.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://NPO NCIT2 /Users/squareroot/temp/UnitTestData/NPO/npo-2011-12-08_inferred.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://MA NCIT2 /Users/squareroot/temp/UnitTestData/Mouse_Anatomy/ma_07_27_2016.owl | sed 's/^/      /'
/opt/stardog/bin/stardog data add --named-graph http://Zebrafish NCIT2 /Users/squareroot/temp/UnitTestData/Zebrafish/zfa_2019_08_02.owl | sed 's/^/      /'
